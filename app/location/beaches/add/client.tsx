...
export default function BeachAddClient() {
  ...
  const [state, action] = useFormState(registerBeach, null);
  ...
  async function registerBeach(_: any, formData: FormData) {
    ...
    console.log(newFormData.getAll("files"));
    return await uploadBeach(null, newFormData);
  }
